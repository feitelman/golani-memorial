...
export default function MapExperience({
  ...
  // Return to the locations overview and leave tour mode.
  ...
  // Closing the panel: in a tour this advances to the next station (the runner
  // effect handles its camera/movement/open); in free mode it just closes.
